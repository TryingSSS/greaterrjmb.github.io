...
<script src="assests/jquery/jquery.formatcurrency.js"></script>
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control currency" id="rate" placeholder="Price" name="rate" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	     	        
			...
			<hr></hr>
		  <center><h3  class="col-sm-12 ">Supplier Details </h3></center>
		   <div class="form-group">
			 ...
			 <div class="form-group">
	        	<label for="price" class="col-sm-3 control-label">Supplier Price: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="number" class="form-control element" id="price" placeholder="Supplier Price" name="price" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	   
			
			 <div class="form-group">
	        	<label for="qty" class="col-sm-3 control-label">Quantity: <small>(Quantity that must be left before ordering again)</small> </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="number" class="form-control element" id="qty" placeholder="Quantity" name="qty" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->

					<div class="form-group">
					<label for="qtyorder" class="col-sm-3 control-label">Quantity Order: <small>(Default quantity for ordering)</small> </label>
					<label class="col-sm-1 control-label">: </label>
						<div class="col-sm-8">
						<input type="number" class="form-control element" id="qtyorder" placeholder="Quantity" name="qtyorder" autocomplete="off">
						</div>
					</div> <!-- /form-group-->	
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <ul class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"><a href="#supplierdetails" aria-controls="profile" role="tab" data-toggle="tab">Supplier Details</a></li>
				  </ul>
				  ...
				  <div class="tab-content">
			        ...
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="number" class="form-control currency" id="editRate" placeholder="Price" name="editRate" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	     	        
					...
					<div role="tabpanel" class="tab-pane" id="supplierdetails">
				    	<form action="php_action/editProductDetail.php" method="POST" id="updateSupplierDetailsForm" class="form-horizontal" enctype="multipart/form-data">

				    	<br />
				    	<div id="edit-supplierDetails-messages"></div>   	           	       
				    	

				      <input type="hidden" id="editproductId" name="productId" autocomplete="off">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select type="text" class="form-control" id="editsupplierName" placeholder="Supplier Name" name="editsupplierName" >
				      	<option value="">~~SELECT~~</option>
				      	<?php 
				      	$sql = "SELECT supplier_id, supplier_name FROM suppliers";
								$result = $connect->query($sql);
			 ...
			 <div class="form-group">
	        	<label for="editprice" class="col-sm-3 control-label">Supplier Price: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="number" class="form-control element currency" id="editprice" placeholder="Supplier Price" name="editprice" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	   
			
			 <div class="form-group">
	        	<label for="editqty" class="col-sm-3 control-label">Quantity Limit: <small>(Quantity that must be left before ordering again)</small> </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="number" class="form-control element" id="editqty" placeholder="Quantity" name="editqty" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->

			
			<div class="form-group">
	        	<label for="editqtyorder" class="col-sm-3 control-label">Quantity Order: <small>(Default quantity for ordering)</small> </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="number" class="form-control element" id="editqtyorder" placeholder="Quantity" name="editqtyorder" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	
			       	           	       

			        <div class="modal-footer editSupplierDetailsFooter">
				        <button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> Close</button>
                        <button type="submit" class="btn btn-success" id="editSupplierDetailBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> Save Changes</button>
				      </div>
				      <!-- /modal-footer -->
				      </form>
				      <!-- /form -->
...
<script src="custom/js/product.js?v=30"></script>
